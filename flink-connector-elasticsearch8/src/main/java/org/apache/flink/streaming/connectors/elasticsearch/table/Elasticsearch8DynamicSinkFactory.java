...
/** A {@link DynamicTableSinkFactory} for discovering {@link Elasticsearch8DynamicSink}. */
@Internal
public class Elasticsearch8DynamicSinkFactory implements DynamicTableSinkFactory {
    ...
    public DynamicTableSink createDynamicTableSink(Context context) {
        ...
        Elasticsearch8Configuration config =
                new Elasticsearch8Configuration(configuration, context.getClassLoader());

        validate(config, configuration);

        return new Elasticsearch8DynamicSink(
                format,
                config,
    ...
    private void validate(Elasticsearch8Configuration config, Configuration originalConfiguration) {
